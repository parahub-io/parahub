...
(() => {
  ...
  // patched: serve draco decoder from local /draco/ instead of gstatic CDN (CSP)
  // Must be absolute URL — loaders.gl getLibraryUrl() only treats values starting
  // with "http" as final, otherwise it falls through to its own CDN.
  var STATIC_DECODER_URL = `${self.location.origin}/draco`;
