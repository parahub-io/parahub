...
<template>
  <div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <!-- Back -->
      <NuxtLink :to="localePath(`/org/${estSlug}/blog`)" class="inline-flex items-center gap-1 text-sm text-neutral-500 hover:text-secondary mb-4">
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center gap-4 mt-3 text-sm text-neutral-500 dark:text-neutral-400">
            <div class="flex items-center gap-1.5">
              <User class="w-4 h-4" />
              <NuxtLink :to="localePath(`/u/${post.author_hna.split('@')[0]}`)" class="text-link">
