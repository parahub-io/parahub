export const useDocNav = () => {
  ...
  const pages = [
    ...
    { path: '/docs/marketplace', titleKey: 'about.marketplaceSystem.title' },
    { path: '/docs/barter', titleKey: 'about.barterSystem.title' },
    { path: '/docs/rental', titleKey: 'about.rentalSystem.title' },
    { path: '/docs/governance', titleKey: 'about.governanceSystem.title' },
    { path: '/docs/ads', titleKey: 'about.adsSystem.title' },
    { path: '/docs/subscriptions', titleKey: 'about.subscriptionsSystem.title' },
    ...
    { path: '/docs/directory', titleKey: 'about.directorySystem.title' },
